...
OUTPUT_PIN = "LED"                # e.g. "LED" or 15 for subscriber, None for publisher
PUB_IDENT = None           # unique ID for publisher, None for subscriber
client_id = b"pico-subscriber"
...
TEMP_THRESHOLD = 32.0            # threshold for turning output ON
...
def connect_wifi(wifi_obj, ssid, password, timeout=10):
    ...
    while timeout > 0:
        if wifi_obj.isconnected():
            ...
            print("BROKER_HOST:", BROKER_HOST, "PORT:", PORT)
            return True
